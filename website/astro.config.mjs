    ...
    starlight({
      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            { label: 'fenix.mod.json', slug: 'reference/mod-metadata' },
            {
              // Generated by `gradlew apiDocsSite`, from the javadoc in the
              // source. Named here rather than autogenerated so the group has a
              // label a reader recognises instead of the directory's name.
              label: 'API reference',
              translations: { fr: "Référence de l'API" },
              collapsed: true,
              // Nested in `items` rather than beside `autogenerate`: Starlight
              // stopped accepting a label on an autogenerated group.
